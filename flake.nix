{
  description = "compootuers flake-parts module";
          ...
          options.flake = flake-parts-lib.mkSubmoduleOptions {
            compootuers = {
              perSystem = lib.mkOption {
                ...
                default = null;
                description = "directory tree: <root>/<s>/<host>/*.nix";
              };

              perArch = lib.mkOption {
                type = lib.types.nullOr lib.types.path;
                default = null;
                description = "optional overrides per architecture: <root>/<s>/both|default|iso.nix";
              };
